...
function Rating({ onSubmit, setRating, rating }) {
  return (
    <div className="rating__conatiner">
      <RatingTitle />
      <RatingButtons
        onSubmit={onSubmit}
        rating={rating}
...
function RatingButtons({ onSubmit, setRating, rating }) {
  function handleRatingClick(event) {
    const rateNumber = Number(event.target.getAttribute("data-value"));
    ...
    <div className="rating__buttons">
      <div className="buttons">
        {[1, 2, 3, 4, 5].map((value) => (
          <div
            key={value}
            className={`rate ${rating === value ? "selected" : ""}`}
            data-value={value}
  ...
  return (
    <div className="rating__value">
      <div className="rating__img">
        ...
        <p className="rating__selection">You selected {rating} out of 5</p>
      </div>
    </div>
  );
}
